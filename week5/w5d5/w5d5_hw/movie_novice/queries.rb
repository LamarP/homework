...
def find_angelina
  ...
  #calls on the actors class and finds the information related to the name ang
end
...
def top_titles
  ...
  Movie 
    .select(:id, :title)
    .where('score >= 9')
  #where the score is greater than or equal to nine
end
...
def star_wars
  ...
  #where each title has star wars 
end
